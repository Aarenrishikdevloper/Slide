...
const BreadCrumbs = ({page,slug}: Props) => {
  let cleaned = slug!.replace(/null/g, "");
  return (
         ...
         <div className="flex justify-center w-full">
             <div className=" radial--gradient w-4/12 py-5 lg:py-10 flex flex-col items-center">
               ...
               <h2 className='capitalize text-4xl font-medium'>
                {cleaned.replace(/([a-z])([A-Z])/g, '$1 $2')}
               </h2>
             </div>
         </div>
       )}
       <span className=' radial--gradient inline-flex  lg:py-10 pr-16 gap-x-2 items-center'>  
